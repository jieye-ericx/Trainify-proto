...
# range={
#   "distance_to_center": { min: [ -2.7642276643855443 ], max: [ 2.0266766666554763 ] },
#   "goal_relative_pos": { min: [ 0, 0 ], max: [ 0, 0 ] },
#   "heading_errors": {
#     min: [
#       -0.014377156162210705, -0.019046737682786318,
#       -0.036049430952979584,  -0.05480349861533624,
#        -0.05480349861533624,  -0.05480349861533624,
#         -0.0548036391185272,   -0.0548036391185272,
#         -0.0548036391185272,   -0.0548036391185272,
#         -0.0548036391185272,   -0.0548036391185272,
#        -0.05480364086409186,  -0.05480364086409186,
#        -0.05480364086409186,  -0.05480364086409186,
#        -0.05480364086409186,  -0.05480364086409186,
#        -0.05480364086409186,  -0.05480366159313176
#     ],
#     max: [
#        0.05286188047599263, 0.05286188047599263,
#       0.053716299189935444, 0.05480183236878702,
#        0.05480281485210121, 0.05480281485210121,
#       0.054803225649522565, 0.05480335676469457,
#        0.05480363756195531, 0.05480363756195531,
#        0.05480363756195531, 0.05480366514878951,
#        0.05480366514878951, 0.05480366514878951,
#        0.05480366514878951, 0.05480366514878951,
#        0.05480366514878951, 0.05480366514878951,
#        0.05480366514878951, 0.05480366514878951
#     ]
...
#     ]
#   },
#   "speed": { min: [ 0.0001368818987024844 ], max: [ 82.22042616450076 ] },
#   "steering": { min: [ -0.479751679585401 ], max: [ 0.47668682886520464 ] }
# }
