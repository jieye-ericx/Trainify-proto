...
if __name__ == "__main__":
    ...
    env_config = {
        ...
        "abs_initial_intervals": [0.05, 0.05],
        "state_key_dim": [0, 1],
        "dynamics": ['x[0] + x[1] * 0.1', 'x[1] + (action*x[1]*x[1]-x[0]) * 0.1'],
    }
    ...
    verify_config = {
        "distance_threshold": [0.001, 0.001],
        "initial_set": [0.8, 0.5, 0.9, 0.6],
        "max_step": 20,
        "initial_set_partition": [0.01, 0.1]
    }
